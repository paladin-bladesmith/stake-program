...
/** UndelegatedStakeStateAccount: Undelegated stake state account */
export const PALADIN_STAKE_PROGRAM_ERROR__UNDELEGATED_STAKE_STATE_ACCOUNT = 0x14; // 20
...
export type PaladinStakeProgramError =
  ...
  | typeof PALADIN_STAKE_PROGRAM_ERROR__UNDELEGATED_STAKE_STATE_ACCOUNT;
...
if (__DEV__) {
  paladinStakeProgramErrorMessages = {
    ...
    [PALADIN_STAKE_PROGRAM_ERROR__UNDELEGATED_STAKE_STATE_ACCOUNT]: `Undelegated stake state account`,
  };
}
