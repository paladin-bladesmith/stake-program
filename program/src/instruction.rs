...
pub enum Instruction {
    ...
    #[account(1, name="authority", desc="Config authority")]
    ...
    #[account(1, writable, name="validator_stake", desc="Validator stake account (pda of `['stake', validator, config]`)")]
    ...
    #[account(1, writable, name="validator_stake", desc="Validator stake account")]
    ...
    #[account(7, name="spl_token", desc="SPL Token 2022 program")]
    StakeTokens(u64),

    /// Deactivate staked tokens for the validator.
    #[account(0, writable, name="stake", desc="Validator stake account")]
    #[account(1, signer, name="authority", desc="Authority on validator stake account")]
    DeactivateStake(u64),
    ...
    #[account(3, writable, name="destination_token", desc="Destination token account")]
    #[account(4, signer, name="stake_authority", desc="Stake authority")]
    #[account(5, name="vault_authority", desc="Vault authority")]
    ...
    #[account(1, writable, name="stake", desc="Stake account")]
    #[account(2, writable, name="vault_token", desc="Vault token account")]
    #[account(3, name="holder_rewards", desc="Holder rewards account for vault token account")]
    #[account(4, writable, name="destination", desc="Destination account for withdrawn lamports")]
    #[account(5, signer, name="authority", desc="Stake authority")]
    #[account(6, signer, name="vault_authority", desc="Vault authority")]
    #[account(7, signer, name="mint", desc="Stake token mint")]
    ...
    #[account(3, signer, name="authority", desc="Stake authority")]
    HarvestStakeRewards,
